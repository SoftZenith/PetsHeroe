...
namespace PetsHeroe.Droid.mx.com.petshero {
    ...
    public partial class wsPetsApp : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Data.DataTable CAM_Busca(int IDCiudad, int IDAsociado) {
        ...
        /// <remarks/>
        public void CAM_BuscaAsync(int IDCiudad, int IDAsociado) {
            this.CAM_BuscaAsync(IDCiudad, IDAsociado, null);
        }
        
        /// <remarks/>
        public void CAM_BuscaAsync(int IDCiudad, int IDAsociado, object userState) {
            ...
            this.InvokeAsync("CAM_Busca", new object[] {
                        IDCiudad,
                        IDAsociado}, this.CAM_BuscaOperationCompleted, userState);
        }
        ...
        public bool Codigo_Valida(string Codigo, out int IDCodigo, out int IDEstatusCodigo, out int IDMascotaCodigo, out string Error) {
